...
* *contest-id* - **Optional.** If specified, the *player-id* becomes required. Indicates the ID of the contest to retrieve a player card for.
* *player-id* - **Optional.** If specified, the *contest-id* becomes required. Indicates the ID of the player to retrieve a player card for.
